...
describe CartsController do
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested cart" do
        ...
        put :update, :id => cart.id, :cart => {'these' => 'params'}
      end

      it "assigns the requested cart as @cart" do
        cart = Cart.create! valid_attributes
        put :update, :id => cart.id, :cart => valid_attributes
        assigns(:cart).should eq(cart)
      end
    ...
    describe "with invalid params" do
      it "assigns the cart as @cart" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Cart.any_instance.stub(:save).and_return(false)
        put :update, :id => cart.id.to_s, :cart => {}
        assigns(:cart).should eq(cart)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested cart" do
      ...
      expect {
        delete :destroy, :id => cart.id.to_s
      }.to change(Cart, :count).by(-1)
    end
